   ...
   <!--   <view class="tn-margin wallpaper-shadow tn-padding" v-for="(item,index) in 16" :key="index" @click="tn('/pageB/chat/chat')">
        <view class="tn-flex tn-flex-col-top">
          <view class="">
            <view class="logo-pic">
              <view class="logo-image">
                <view class="" style="background-image:url('https://tnuiimage.tnkjapp.com/blogger/blogger_beibei.jpg');width: 100rpx;height: 100rpx;background-size: cover;">
                </view>
              </view>
            </view>
          </view>
...
<!--            </view>
        ...
        <view class="tn-flex tn-flex-row-between tn-flex-col-between tn-margin-top-sm">
          ...
          <view class="justify-content-item tn-round tn-text-xs tn-bg-orange--light tn-color-orange" style="padding: 5rpx 15rpx;">
